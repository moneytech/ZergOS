...
*	 for ZergOS (IMPORTED)
*
*	Code for drawing shapes to the screen.
******************************************************************************/

/*
* The foreColour used when drawing shapes.
* Signature: short foreColour;
*/
.section .data
.align 1
foreColour:
...
* Signature: FrameBuferDescription* graphicsAddress;
*/
.align 2
graphicsAddress:
	.int 0
...
* Signature: void SetForeColour(u16 colour);
*/
.section .text
.globl SetForeColour
SetForeColour:
...
* graphicsAddress;
* Signature: void SetGraphicsAddress(FrameBuferDescription* value);
*/
...
* Signature: void DrawPixel(u32x2 point);
*/
.globl DrawPixel
DrawPixel:
	px .req r0
...
* Uses Bresenhams Line Algortihm
* Signature: void DrawLine(u32x2 p1, u32x2 p2);
*/
.globl DrawLine
DrawLine:
	...
	dx .req r4
	dyn .req r5 /* store negative for speed. (hence dyn) */
	sx .req r6
	sy .req r7
	err .req r8
...
* Signature: u32x2 DrawCharacter(char character, u32 x, u32 y);
*/
.globl DrawCharacter
DrawCharacter:
	x .req r4
...
* Signature: void DrawString(char* string, u32 length, u32 x, u32 y);
*/
.globl DrawString
DrawString:
	x .req r4
