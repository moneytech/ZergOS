...
*
*	The magic happens here! The cmd Terminal of the OS
******************************************************************************/
...
/* 
* terminalStart - the address in the terminalBuffer of the first valid 
* character.
* Signature: u32 terminalStart;
*/
terminalStart:
	.int terminalBuffer

/* 
* terminalStop - the address in the terminalBuffer of the last valid
* character.
* Signature: u32 terminalStop;
*/
terminalStop:
	.int terminalBuffer

/* 
* terminalView - the address in the terminalBuffer of the first displayed
* character.
* Signature: u32 terminalView;
*/
terminalView:
	.int terminalBuffer
	
/* 
* terminalInput - the address in the terminalBuffer of the first character of
...
/* 
* terminalBuffer - all text stored for the console.
* Signature: u16 terminalBuffer[128*128];
*/
.align 8
terminalBuffer:
	.rept 128*128
...
/* 
* terminalScreen - stores the text last rendered to the screen by the console.
* This means when redrawing the screen, only changes need be drawn.
* Signature: u16 terminalScreen[1024/8 * 768/16];
*/
terminalScreen:
	.rept 1024/8 * 768/16
	.byte 0x7f
...
* Signature: void TerminalColour(u8 colour);
*/
TerminalColour:
	teq r0,#6
	ldreq r0,=0x02B5
...
* Signature: void TerminalDisplay();
*/
...
* are obeyed.
* Signature: void Print(char* string, u32 length);
*/
.globl Print
Print:
	teq r1,#0
...
* Signature: u32 Print(char* string, u32 maxLength);
*/
.globl ReadLine
ReadLine:
	teq r1,#0
