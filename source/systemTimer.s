...
*
*	systemTime.s contains the code that interacts with the system 1MHz clock timer.
******************************************************************************/

/*
* GetSystemTimerBase - returns the base address of the System Timer region as a
* physical address in register r0.
* Signature: void* GetSystemTimerBase()
*/
...
* Signature: void Wait(u32 delayInMicroSeconds)
*/
.globl Wait
Wait:
	delay .req r2
