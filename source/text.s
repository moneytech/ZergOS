...
*
*	contains code for text manipulation
******************************************************************************/

/* 
* ReverseString - reverses a string, with pointer in r0, and length in r1.
* Signature: void ReverseString(char* string, u32 length);
*/
.globl ReverseString
ReverseString:
	start .req r0
...
* in r1 and returns the length of the string in r0. If r1 is 0, this doesnt
* Signature: u32 UnsignedString(u32 value, char* string, u32 base)
*/
...
* in r1 and returns the length of the string in r0.
* Signature: u32 SignedString(s32 value, char* string, u32 base);
*/
.globl SignedString
SignedString:
	value .req r0
...
* returns the length of the constructed string.
* Signature: u32 FormatString(char* format, u32 length, char* dest, ...);
