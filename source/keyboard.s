...
.section .data
/* 
* The address of the keyboard were reading from.
* Signautre: u32 KeyboardAddress;
*/
.align 2
KeyboardAddress:
	.int 0
...
* not 0 otherwise.
* Signature bool KeyWasDown(u16 scanCode)
*/
.globl KeyWasDown
KeyWasDown:
	ldr r1,=KeyboardOldDown
...
* character was typed.
* Signature char KeyboardGetChar()
*/
