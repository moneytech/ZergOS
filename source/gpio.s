...
*
*	contains the rountines for manipulation of the GPIO ports.
******************************************************************************/

/*
* GetGpioAddress - returns the base address of the GPIO region as a physical address
* in register r0.
* Signature: void GetGpioAddress()
*/
...
* low  3 bits of r1.
* Signature: void SetGpioFunction(u32 gpioRegister, u32 function)
*/
...
* otherwise. 
* Signature: void SetGpio(u32 gpioRegister, u32 value)
*/
.globl SetGpio
SetGpio:	
    pinNum .req r0
